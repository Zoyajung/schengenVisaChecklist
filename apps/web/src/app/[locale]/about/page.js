    ...
    <main className="min-h-screen bg-slate-50">
      <Container className="py-14">
        <div className="mx-auto max-w-4xl">
          <MotionReveal className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            <p className="text-sm font-bold text-tertiary">{t(messages, 'about.eyebrow')}</p>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {sections.map((section, index) => {
              ...
              return (
                <MotionReveal key={section.title} className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="flex h-10 w-10 items-center justify-center rounded-md bg-tertiary/10 text-primary">
          ...
          {principles.length ? (
            <MotionReveal className="mt-6 rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <MotionReveal className="mt-6 rounded-lg border border-tertiary/30 bg-tertiary/10 p-5 text-sm leading-6 text-slate-800">
